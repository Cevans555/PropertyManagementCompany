        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidenceSectionSavedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResidenceSectionVersion = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedById = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedById = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RentalApplications_ApplicationStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "ApplicationStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RentalApplications_AspNetUsers_ClaimedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetailsSavedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Applicants_RentalApplications_RentalApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ManagerNotes_RentalApplications_RentalApplicationId",
                        column: x => x.RentalApplicationId,
                        principalTable: "RentalApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PostalCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    LandlordName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResidenceHistories_RentalApplications_RentalApplicationId",
                        column: x => x.RentalApplicationId,
                        principalTable: "RentalApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusHistories_ApplicationStatuses_FromStatusId",
                        column: x => x.FromStatusId,
                        principalTable: "ApplicationStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StatusHistories_ApplicationStatuses_ToStatusId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StatusHistories_RentalApplications_RentalApplicationId",
                        column: x => x.RentalApplicationId,
                        principalTable: "RentalApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "IsTerminal", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, false, "Draft", 1 },
                    { 2, false, "Submitted", 2 },
                    { 3, false, "Under Review", 3 },
                    { 4, false, "Returned", 4 },
                    { 5, true, "Approved", 5 },
                    { 6, true, "Denied", 6 },
                    { 7, true, "Withdrawn", 7 }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applicants_RentalApplicationId_UserId",
                table: "Applicants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManagerNotes_RentalApplicationId",
                table: "ManagerNotes",
                column: "RentalApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_RentalApplications_ClaimedById",
                table: "RentalApplications",
                column: "ClaimedById");

            migrationBuilder.CreateIndex(
                name: "IX_RentalApplications_StatusId",
                table: "RentalApplications",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidenceHistories_RentalApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusHistories_RentalApplicationId",
                table: "StatusHistories",
                column: "RentalApplicationId");
